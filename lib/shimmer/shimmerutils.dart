...
class ShimmerUtils {
  ...
  static Widget normalHorizontalGrid(BuildContext context, double itemHeight,
      double itemWidth, int crossAxisCount) {
    return Container(
  ...
  static Widget normalVerticalGrid(BuildContext context, double itemHeight,
  ...
  static Widget responsiveGrid(BuildContext context, double itemHeight,
      double itemWidth, int minCrossCount, int itemCount) {
    return Container(
      padding: const EdgeInsets.fromLTRB(20, 8, 20, 8),
  ...
  static Widget buildDetailMobileShimmer(
      BuildContext context, String detailType) {
    return Column(
      children: [
        /* Poster */
        Stack(
  ...
  static Widget buildAvatarGridShimmer(BuildContext context, double itemHeight,
      double itemWidth, int crossAxisCount, int itemCount) {
    return AlignedGridView.count(
      shrinkWrap: true,
      crossAxisCount: crossAxisCount,
  ...
  static Widget buildAvatarGridWebShimmer(BuildContext context,
      double itemHeight, double itemWidth, int crossAxisCount, int itemCount) {
    return Container(
      padding: const EdgeInsets.fromLTRB(20, 8, 20, 8),
      child: ResponsiveGridList(
        minItemWidth: itemWidth,
  ...
  static Widget buildClipsWEBShimmer(
      BuildContext context, bool isFromBottomBar) {
    return Stack(
      alignment: Alignment.center,
      children: [
        ShimmerWidget.roundrectborder(
